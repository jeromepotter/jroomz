...
(() => {
  ...
  const PRESETS = [
    ...
    {
      name: "SNAP-CRACKLE",
      params: { tempo: 110, vco1Freq: 0.6, noiseLevel: 0.6, cutoff: 0.6, vcfDecay: 0.1, vcaDecay: 0.1, reverbMix: 0.1, delayWet: 0.0, masterHP: 0.2, masterLP: 1.0 },
    ...
    {
      name: "RUST-BUCKET",
      params: { tempo: 90, vco1Wave: 1, vco2Wave: 1, fmAmount: 0.8, noiseLevel: 0.3, cutoff: 0.7, resonance: 0.7, vcaDecay: 0.2, delayWet: 0.1, masterHP: 0.1, masterLP: 0.9 },
      steps: Array(8).fill(null).map(() => ({ pitch: Math.random(), velocity: Math.random() > 0.3 ? 0.7 : 0.0 }))
    },
    {
      name: "DEEP-DIVE",
      params: { tempo: 60, vco1Freq: 0.05, vco1Wave: 0, cutoff: 0.2, vcfEgAmt: 0.1, vcaEgMode: 1, vcaDecay: 0.9, reverbMix: 0.6, reverbDecay: 0.9, delayWet: 0.0, masterHP: 0.0, masterLP: 0.4 },
    ...
    {
      name: "PING-PONGER",
      params: { tempo: 125, vco1Freq: 0.7, vcoDecay: 0.05, cutoff: 0.8, vcaDecay: 0.05, delayWet: 0.5, delayFdbk: 0.7, delayRate: 0.25, delayWidth: 1.0, masterHP: 0.0, masterLP: 1.0 },
    ...
    {
      name: "STATIC-SHOCK",
      params: { tempo: 150, noiseLevel: 1.0, vco1Level: 0.0, vco2Level: 0.0, cutoff: 0.9, resonance: 0.4, vcaDecay: 0.05, delayWet: 0.0, masterHP: 0.5, masterLP: 1.0 },
      steps: Array(8).fill(null).map(() => ({ pitch: 0.5, velocity: Math.random() > 0.5 ? 0.9 : 0.0 }))
    },
    {
      name: "WOOD-BLOCK",
      params: { tempo: 128, vco1Freq: 0.5, vco1Wave: 0, vco1EgAmt: 0.6, vcoDecay: 0.05, cutoff: 0.5, resonance: 0.5, vcaDecay: 0.05, reverbMix: 0.2, masterHP: 0.1, masterLP: 1.0 },
    ...
    {
      name: "KLAXON-ALARM",
      params: { tempo: 160, vco1Freq: 0.5, vco2Freq: 0.52, vco1Wave: 1, vco2Wave: 1, cutoff: 1.0, vcaDecay: 0.5, delayWet: 0.0, masterHP: 0.0, masterLP: 1.0 },
    ...
    {
      name: "DATA-STREAM",
      params: { tempo: 140, vco1Freq: 0.8, fmAmount: 0.9, vco2Freq: 0.1, cutoff: 0.6, vcfEgAmt: 0.9, vcfDecay: 0.05, vcaDecay: 0.05, delayWet: 0.2, masterHP: 0.0, masterLP: 1.0 },
      steps: Array(8).fill(null).map(() => ({ pitch: Math.random(), velocity: Math.random() }))
    },
    {
      name: "CAVE-DRIP",
      params: { tempo: 80, vco1Freq: 0.8, vco1Wave: 0, vcoDecay: 0.1, cutoff: 0.4, resonance: 0.8, vcfEgAmt: 0.6, reverbMix: 0.8, reverbDecay: 0.9, delayWet: 0.0, masterHP: 0.1, masterLP: 1.0 },
